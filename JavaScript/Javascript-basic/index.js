...
* La funcion debe regresar un arreglo de objetos de tipo corrida con los siguientes atributos.
 ...
 - tienePromoción. Boolean. Deberá ir en true en caso de que una de las corridas web tenga 
    lista de descuetos "listaDescuentos"
...
* En caso de no encontrar corridas, regresar un error con el mensaje "No hay corridas disponibles"*/
  ...
  function Buscar(nombreEmpresa = 'AEF', descServicio){
    //REALIZA LA BUSQUEDA DE EMPRESA  Y DE LA DESCRIPCIÓN SERVICIO
    const busca = corridasWeb.filter(corridasWeb => corridasWeb.empresa === nombreEmpresa 
        && corridasWeb.descripcionServicio === descServicio);
        //SI LA BUSQUEDA ES MAYOR A CERO ENTONCES IMPRIME LO ENCONTRADO EN "busca"
        if (busca.length > 0) {
            console.log('Empresa:', nombreEmpresa, '\nDescripción servicio:',descServicio);
            
            //DESPUÉS HACE UN RECORRIDO EN EL ARREGLO "arregloObjetos" BUSCANDO LOS PARÁMETROS SOLICITADOS
            //Y A SU VEZ LOS VA IMPRIMIENDO EN CADA ITERACIÓN
            for (let i of busca){
        ...
        //DE LO CONTRARIO, DE NO HABER CORRIDAS DISPONIBLES NOS MANDARÁ UN MENSAJE DE ERROR.
            ...
            console.error("No hay corridas disponibles");
        }
  }

  //EJECUTA LA FUNCIÓN
Buscar('TCH', 'PRIMERA SELECT');
